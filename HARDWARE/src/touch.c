...
void Convert_Pos(u16 *x, u16 *y)
{		 	  
//	if(Read_ADS2(&Board.X,&Board.Y))
//	{
//		Pen_Point.X0=Pen_Point.xfac*Pen_Point.X+Pen_Point.xoff;
//		Pen_Point.Y0=Pen_Point.yfac*Pen_Point.Y+Pen_Point.yoff;
//	}
    *x = ADS_Read_XY(CMD_RDX);
	*y = ADS_Read_XY(CMD_RDY);
	if(*x>220 && *y>160)
	{
	    *x = (ADS_Read_XY(CMD_RDX)-220)/7;
	    *y = (ADS_Read_XY(CMD_RDY)-160)/5.3;
	}
	else
	{
	    *x = 0;
